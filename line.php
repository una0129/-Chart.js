  ...
  <div class="wrapper">
    <nav id="sidebar">
      ...
      <ul class="list-unstyled CTAs">
        <li>
          <a href="https://drive.google.com/file/d/1Qsc8aFooeLw5HRhAnapID5eez0uyGXVv/view?usp=sharing"
            class="download">資源下載.csv</a>
        </li>
        <li>
          <a href="https://drive.google.com/file/d/10qqNfoZDzooPSvmGMuAK9WaZKC2bK2xF/view?usp=sharing"
            class="article">資料下載.json</a>
        </li>
      </ul>
    </nav>
      ...
      <section>
        <div class="row">
          <div class="col-12 mt-3 mb-1">
            <!-- <h5 class="">Total Electricity Sales dashboard </h5> -->
          </div>
        </div>
        <div class="row">
