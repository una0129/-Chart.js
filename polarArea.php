        ...
        <script>
          ...
          const data = {
            ...
            datasets: [{
              label: '台中市',
              backgroundColor: [
                'rgba(250, 159, 159, 0.5)',
                'rgba(244, 250, 159, 0.5)',
                'rgba(167, 250, 159, 0.5)',
                'rgba(159, 232, 250, 0.5)'
              ],
              data: Txg,
            },
          ...
          const myChart_polarArea = new Chart(
